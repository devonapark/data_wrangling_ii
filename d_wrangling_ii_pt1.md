...
Now use selector (selector gadget) to pull out the elements that I care
about!
...
Everytime you press knit –\> it will go to the internet and pull data.
So if you are using big data, you may want to limit the number of times
you knit (because it will start to take a while)
...
<img src="d_wrangling_ii_pt1_files/figure-gfm/unnamed-chunk-10-1.png" width="90%" />

Using APIs can get a little tricky… You ay need to create an account and
get an app token
